...
def evaluate_model(model: str, validation_page: str):
    ...
    ocr_page = Path(WORKING_DIR, 'transcriptions/', model, f'{validation_page}.md')
...
if __name__ == "__main__":
    ...
    evaluate_model(args.model, args.validation_page)