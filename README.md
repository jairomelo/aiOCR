...
- Phi-3.5-vision [model card](https://huggingface.co/microsoft/Phi-3.5-vision-instruct), LLaVA-7b [model card](https://ollama.com/library/llava:7b), mistral 7B [model card](https://ollama.com/library/mistral:latest), and Qwen3-Coder-Next [model card](https://ollama.com/library/qwen3-coder-next:latest) -> Generate excessive hallucinations in limited GPU settings.
